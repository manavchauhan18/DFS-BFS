...
class Maze():
    ...
    def _init__(self, filename):
        ...
        contents = contents.splitlines() #Splits the string based on the lines.
        self.height = len(contents) #Length of the contents = height
        self.width = max(len(line) for line in contents) #Max length of line in the contents = width
    ...
    def output_image(self, filename, show_solution=True, show_explored=False):
        ...
        for i, row in enumerate(self.walls):
            for j, col in enumerate(row):
                ...
                draw.rectangle(
                    ([(j * cell_size + border, i * cell_size + cell_border),
